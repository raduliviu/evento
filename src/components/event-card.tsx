...
export default function EventCard({ event }: EventCardProps) {
  return (
    ...
    >
      <section className='w-full h-full flex flex-col bg-white/5 rounded-xl overflow-hidden relative hover:scale-105 active:scale-[1.02] transition'>
        <Image
          src={event.imageUrl}
          alt={event.name}
          width={500}
